...
/**
 * https://leetcode.cn/problems/remove-duplicates-from-sorted-array-ii/description/?envType=study-plan-v2&envId=top-interview-150<br>
 *
 * @author namelessmyth
 * @version 1.0
 * @date 2023/9/15
...
public class Lee80 {
    ...
    public static void main(String[] args) {
        ...
        int k = new Lee80().removeDuplicates2(nums1);
