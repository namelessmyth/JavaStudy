package com.sjj.mashibing.algorithm.distance;

import java.util.PriorityQueue;

/**
 * 条件：int n, int[] roads, int x, int y。其中n表示城市数量，城市编号：0~(n-1)，roads [i] [j] == distance，表示城市i到城市i距离为distance (无向图)，求城市x到城市y的最短距离。<br>
 *
 * @author namelessmyth
 * @version 1.0
 * @date 2023/9/15
